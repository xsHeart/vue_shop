          ...
          <el-table :data="manyTableData" border stripe>
            ...
            <el-table-column label="操作">
              ...
              <template slot-scope="scope">
                ...
                <el-button size="mini" type="danger" icon="el-icon-detale" @click="removeParams(scope.row.attr_id)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    showInput (row) {
      ...
      // 让文本框自动获得焦点
      // $nextTick 方法的作用，就是当页面上元素被重新渲染之后，才会执行回调函数中的代码，也就是在把布尔值重置为true时，页面并没有重新渲染
      this.$nextTick(_ => {
